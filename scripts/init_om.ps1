...
$content = get-content "../templates/director_varsyml"
...
$content | Set-Content $HOME/director_varsyml
...
Write-Host "Now Uploading OM Certs"
 ...
 om --env $HOME/om_$($director_conf.RG).env `
    configure-director --config "$PSScriptRoot/../templates/director_configyml" --vars-file "$HOME/director_varsyml"
